 ...
 */
public class CombinedAvroMultipleInputsKeyInputFormat<T> extends
		CombineFileInputFormat<AvroKey<T>, NullWritable> {
	private final Logger LOG = Logger
			.getLogger(CombinedAvroMultipleInputsKeyInputFormat.class);
	...
	public RecordReader<AvroKey<T>, NullWritable> createRecordReader(
		...
		Schema readerSchema = AvroMultipleInputsUtil.getInputKeySchemaForSplit(
				context.getConfiguration(), inputSplit);
